...
class SliderDetailHeadLangsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('slider_detail_head_langs')->delete();
        
        \DB::table('slider_detail_head_langs')->insert(array (
            0 => 
            array (
                'id' => 1,
                'slider_detail_id' => 1,
