...
class SliderDetailBtnLangsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('slider_detail_btn_langs')->delete();
        
        \DB::table('slider_detail_btn_langs')->insert(array (
            0 => 
            array (
                'id' => 1,
                'slider_detail_id' => 1,
            ...
            array (
                ...
                'lang_id' => 2,
                'text' => 'Apply Now',
                'created_at' => '2017-10-21 18:23:39',
                'updated_at' => '2017-10-23 17:46:54',
                'deleted_at' => NULL,
            ),
        ));
