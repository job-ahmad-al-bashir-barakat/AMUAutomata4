@if((sizeof($files) > 0) || (sizeof($directories) > 0))
  <table class="table table-responsive table-condensed table-striped hidden-xs table-list-view">
    ...
    @foreach($items as $item)
      <tr class="table-row">
        <td>
          <i class="fa {{ $item->icon }}" style="padding: 0 15px;"></i>
        ...
        <td class="actions" style="text-align: center;">
          <div class="btn-group">
            ...
            <button class="btn btn-sm dropdown-toggle btn-default" type="button" data-toggle="dropdown" aria-expanded="false">
              <span class="caret"></span>
              <span class="sr-only">default</span>
            </button>
            <ul class="dropdown-menu" role="menu" style="min-width: 80px; text-align: center;">
              @if($item->is_file)
                <li>
