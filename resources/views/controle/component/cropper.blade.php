    ...
    <div>
        <div class="row">
            <div class="col-lg-3 col-md-3 col-xs-12 pull-right">
                <div>
                    @component('controle.component.panel' ,['title' => trans('app.crop_detail') ,'active' => false])
                ...
                <div>
                    ...
                    @if($single)
                        <button type="button" class="btn btn-success btn-block mt" data-method="getCroppedCanvas" data-type="upload">{{ trans('app.upload') }}</button>
                    @endif
                    <div class="btn-group btn-block btn-group-sm mt">
                        <button type="button" class="btn btn-primary" style="width: 85%;">{{ trans('app.file_manager') }}</button>
                        ...
                        <ul role="menu" class="dropdown-menu" style="width: 100%;">
                            <li>
                                <a for="inputImageManager" title="{{ trans('app.open_manager') }}" href="javascript:open_popup('{{ localizeURL('filemanager/dialog?type=1&popup=1&field_id=inputImageManagerUrl') }}')">
                                    <span>{{ trans('app.open_manager') }}</span>
                                </a>
                            </li>
                            <li>
                                <a for="inputImageManager" title="{{ trans('app.apply_file_to_cropper') }}" data-method="getCroppedCanvas" data-type="applyFilemanager" href="javascript:void(0)">
                                    <span>{{ trans('app.apply_file_to_cropper') }}</span>
                                </a>
                            </li>
                        </ul>
            ...
            <div class="col-lg-9 col-md-9 col-xs-12 pull-left">
                @unless($showName && $showOption)
                    <div>
                        @if($showName)
                            <div class="form-group">
                                <input type="text" id="ImageName" name="ImageName" class="form-control" placeholder="{{ trans('app.image_name') }}">
                            </div>
                        @endif
                        @if($showOption)
