...
<div id="wrapper" class="clearfix">
    ...
    <div class="main-content">
        ...
        <!-- Section: home slider -->
        @include('theme.component.module.home_slider')

        <!-- Section: home-boxes -->
        @include('theme.component.module.home_boxes')

        <!-- Section: About -->
        @include('theme.component.module.about')

        <!-- Section: COURSES -->
        @include('theme.component.module.courses')

        <!-- Divider: Funfact -->
        @include('theme.component.module.fun_fact')

        <!-- Section: team -->
        @include('theme.component.module.team')

        <!-- Section: team -->
        @include('theme.component.module.gallery')

        <!-- Diver: Video Background  -->
        @include('theme.component.module.video_background')

        <!-- Section: Why Choose Us -->
        @include('theme.component.module.event')

        <!-- Section: blog -->
        @include('theme.component.module.blog')

        <!-- Divider: Google Map -->
        @include('theme.component.module.map')

        <!-- Divider: Clients -->
        @include('theme.component.module.clients')
