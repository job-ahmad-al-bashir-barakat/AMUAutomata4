<div class="col-md-4">
    <div class="service-block bg-white">
        ...
        <div class="content text-left flip p-25 pt-0">
            ...
            <a class="btn btn-dark btn-theme-colored btn-sm text-uppercase mt-10" href="{{ RouteUrls::singleCourse(getSlug($course->id, $course->lang_name[$lang]->text)) }}">view details</a>
        </div>
    </div>
</div>