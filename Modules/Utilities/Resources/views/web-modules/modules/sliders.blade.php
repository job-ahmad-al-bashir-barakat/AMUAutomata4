        ...
        <ul>
            ...
            @foreach($data['sliders']->sliderDetails()->with('image')->get() as $sliderDetail)
                ...
                @if($sliderDetail->position == 'L')
                    ...
                    @php($layers['1']['x'] = 'left')
                    @php($layers['1']['hoffset'] = $dir=='rtl'?'1100':'30'){{--30--}}
                    ...
                    @php($layers['2']['x'] = 'left')
                    @php($layers['2']['hoffset'] = $dir=='rtl'?'1095':'35')
                    ...
                    @php($layers['3']['x'] = 'left')
                    @php($layers['3']['hoffset'] = $dir=='rtl'?'1095':'35')
                    ...
                    @php($layers['4']['x'] = 'left')
                    @php($layers['4']['hoffset'] = $dir=='rtl'?'1095':'35')
                ...
                @elseif($sliderDetail->position == 'C')
                    ...
                    @php($layers['1']['hoffset'] = $dir=='rtl'?'100':'0')
                    ...
                    @php($layers['2']['hoffset'] = $dir=='rtl'?'235':'0')
                    ...
                    @php($layers['3']['hoffset'] = $dir=='rtl'?'435':'0')
                    ...
                    @php($layers['4']['hoffset'] = $dir=='rtl'?'80':'0')
                ...
                @elseif($sliderDetail->position == 'R')
                    ...
                    @php($layers['1']['hoffset'] = $dir=='rtl'?'700':'30')
                    @php($layers['1']['voffset'] = '-90')
                    ...
                    @php($layers['2']['hoffset'] = $dir=='rtl'?'760':'35')
                    @php($layers['2']['voffset'] = '-25')
                    ...
                    @php($layers['3']['hoffset'] = $dir=='rtl'?'200':'35')
                    ...
                    @php($layers['4']['hoffset'] = $dir=='rtl'?'900':'35')
