<div class="col-md-{{ $data['width'] }}">
    ...
    <div id="accordion1" class="panel-group accordion">
        ...
        @if($firstStep)
            <div class="panel">
                <div class="panel-title"> <a class="active" data-parent="#accordion_{{ $firstStep->id }}" data-toggle="collapse" href="#accordion11" aria-expanded="true"> <span class="open-sub"></span> {{ $firstStep->lang_title[$lang]->text }}</a> </div>
        ...
        @foreach($data['steps'] as $step)
            <div class="panel">
                <div class="panel-title"> <a data-parent="#accordion_{{ $step->id }}" data-toggle="collapse" href="#accordion12" class="collapsed" aria-expanded="false"> <span class="open-sub"></span> {{ $step->lang_title[$lang]->text }}</a> </div>
